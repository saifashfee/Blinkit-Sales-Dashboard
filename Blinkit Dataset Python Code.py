...
def save_blinkit_data(data_dict, prefix='blinkit_'):
    """Save all generated DataFrames to CSV files in the specified folder"""
    folder = r'C:\Users\SAIF ASHFEE\OneDrive\Desktop\New folder'
    import os
    os.makedirs(folder, exist_ok=True)  # Create the folder if it doesn't exist
    for name, df in data_dict.items():
        file_path = os.path.join(folder, f'{prefix}{name}.csv')
